...
const AboutUs = () => {
    ...
    return (
        <div className="relative w-[1920px] flex flex-col items-start justify-start bg-[#fff] overflow-hidden">
            <div className="relative self-stretch h-[294px] shrink-0 bg-[#fff] overflow-hidden">
                ...
                <div className="flex flex-row items-center justify-start gap-[40px]">
                    <div className="flex flex-col items-center justify-start border-[solid] border-#2d4198 border">
                        <Link to="/aboutus-ceo">
