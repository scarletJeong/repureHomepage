...
import rec1 from './assets/Rectangle 59I9_5285;9_5156.png'
import rec2 from './assets/Rectangle 59I9_5285;9_5158.png'
import rec3 from './assets/Rectangle 59I9_5285;9_5160.png'
    ...
    <div className="relative self-stretch h-[1080px] shrink-0 bg-[#fff]">
      ...
      <div className="absolute -translate-x-1/2 left-1/2 top-[354px] w-[1920px] flex flex-row items-center justify-center gap-[18px] overflow-hidden">
        ...
        <div className="relative w-[180px] h-[600px] shrink-0">
          <img className="absolute left-0 top-0" width="180" height="600" src={rec1}></img>
        </div>
        <div className="relative w-[180px] h-[600px] shrink-0">
          <img className="absolute left-0 top-0" width="180" height="600" src={rec2}></img>
        </div>
        <div className="relative w-[180px] h-[600px] shrink-0">
          <img className="absolute left-0 top-0" width="180" height="600" src={rec3}></img>
        </div>
      </div>
    </div>
    ...
    <div className="relative self-stretch h-[480px] shrink-0 bg-[#f8f8f8]">
      ...
      <div className="absolute left-[1434px] top-[105px] flex flex-row items-center justify-start gap-[20px]">
        ...
        <div className="relative w-[36px] h-[36px] shrink-0 bg-[#fff] rounded-[32px] overflow-hidden">
          <img className="absolute left-[3px] top-[6px]" width="30" height="28" src={goNaverblog}></img>
        </div>
        {/* linked in  */}
        <div className="relative w-[36px] h-[36px] shrink-0">
          <img className="absolute left-0 top-0" width="36" height="36" src={goLinked}></img>
        </div>
        {/* opentarget  */}
        <div className="relative w-[94px] h-[36px] shrink-0">
          <img className="absolute left-[7.45%] right-[6.38%] top-[16.67%] bottom-[16.67%]" width="81" height="24" src={goOpentarget}></img>
        </div>
      </div>
